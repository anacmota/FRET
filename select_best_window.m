...
spaceO = input('Space (nt) in between the oligomers same color: (in case of 1 oligo alternating: 0)\n');
spaceC = input('Space (nt) in between the oligomers different colors:\n');
