...
geneSeq = fileread('Pls3.txt'); %Magix and Pls3 % reference sequence from mouse
...
Oligo = [];
mer = 1;
namePrint = 'Pls3'; % name for the folder
...
% split the file in smaller with split -l 20000 Oligos_List.fa
